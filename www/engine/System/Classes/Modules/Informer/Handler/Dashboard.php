...
namespace Modules\Informer\Handler {
	...
	use Frames, Modules\Informer, Modules\Settings, Utils\Range, Utils\Messages, Utils\View, Geo\Timezone, Language;

	class Dashboard extends Frames\Admin\Area\Authorized {
