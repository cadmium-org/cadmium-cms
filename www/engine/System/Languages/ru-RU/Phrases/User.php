...
return [
	...
	'USER_ERROR_EMAIL_INCORRECT'                    => 'Пользователь с таким e-mail\'ом не найден',
	...
	'USER_SUCCESS_RECOVER_TEXT'                     => 'Теперь вы можете авторизироваться, используя ваш новый пароль',

	'USER_SUCCESS_REGISTER'                         => 'Регистрация была успешно завершена!',
	'USER_SUCCESS_REGISTER_TEXT'                    => 'Теперь вы можете авторизироваться, используя ваше имя пользователя и пароль',
	...
	'USER_FIELD_NAME_EMAIL'                         => 'Имя пользователя или e-mail',
