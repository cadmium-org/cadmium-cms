...
return array (
	...
	'TITLE_CONTENT_PAGES_ADD'				=> 'Добавление страницы',
	'TITLE_CONTENT_PAGES_EDIT'				=> 'Редактирование страницы',

	'TITLE_CONTENT_MENUITEMS'				=> 'Меню',
	'TITLE_CONTENT_MENUITEMS_ADD'			=> 'Добавление элемента',
	...
	'OVERVIEW_ROW_SITE_TITLE'				=> 'Название сайта',
	'OVERVIEW_ROW_SITE_STATUS'				=> 'Статус сайта',

	'OVERVIEW_ROW_SYSTEM_URL'				=> 'Корневой URL',
	'OVERVIEW_ROW_SYSTEM_TIMEZONE'			=> 'Часовая зона',

	'OVERVIEW_ROW_PAGES'					=> 'Всего страниц',
	'OVERVIEW_ROW_USERS'					=> 'Всего пользователей',

	'OVERVIEW_GROUP_GENERAL'				=> 'Основное',
	'OVERVIEW_GROUP_DATABASE'				=> 'База данных',
	...
	'PAGES_ITEM_NOT_FOUND'					=> 'Страница не найдена',
	...
	'MENUITEMS_ITEM_NOT_FOUND'				=> 'Элемент не найден',
	...
	'LANGUAGES_ERROR_CODE'					=> 'Ошибка активации языка',
	...
	'USERS_ITEM_NOT_FOUND'					=> 'Пользователь не найден',

	'USERS_ITEM_EDIT'						=> 'Редактировать',
	'USERS_ITEM_REMOVE'						=> 'Удалить',
	'USERS_ITEM_ADD'						=> 'Добавить пользователя',
	...
	'SETTINGS_FIELD_ADMIN_EMAIL'			=> 'E-mail администратора',

	'SETTINGS_FIELD_USERS_REGISTRATION'		=> 'Разрешить регистрацию пользователей',

	'SETTINGS_ERROR_PARAM'					=> 'Ошибка валидации формы. Некоторые поля содержат неверные значения',
	...
	'INFO_SYSTEM_VERSION'					=> 'Версия CMS',
