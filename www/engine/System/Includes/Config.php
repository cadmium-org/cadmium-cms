...
define('CONFIG_INSTALL_DATABASE_SERVER_MAX_LENGTH',     128);
define('CONFIG_INSTALL_DATABASE_USER_MAX_LENGTH',       64);
define('CONFIG_INSTALL_DATABASE_PASSWORD_MAX_LENGTH',   64);
define('CONFIG_INSTALL_DATABASE_NAME_MAX_LENGTH',       64);
