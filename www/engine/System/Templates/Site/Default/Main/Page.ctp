...
<html lang="$language$">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="$install_path$/assets/$template_name$/styles/main.css" />
		...
		<script src="$install_path$/assets/$template_name$/scripts/view.js"></script>
